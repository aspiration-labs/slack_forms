...
class BaseForm:
    ...
    def __init__(
        self, *, initial: Dict[str, Any] = {}, state: Optional[Dict[str, str]] = None
    ):
    ...
    def data(self) -> Dict[str, Any]:
        return {
            field_name: self[field_name].value for field_name in self.declared_fields
        }
    ...
    def render(self, initial: Dict[str, Any] = {}) -> List[Dict[str, Any]]:
        ...
        return [
            field.render(self.initial.get(cast(str, field.field_name)))
