...
def test_form_view_data() -> Dict[str, Any]:
    ...
    return {
        ...
        'state': {'values': {'text': {'text-action': {'type': 'plain_text_input',
                                                      'value': 'some text'}},
                             'checkbox': {'checkbox-action': {'type': 'checkboxes',
                                                              'selected_options': [{'text': {'type': 'plain_text',
                                                                                             'text': 'check '
                                                                                                     '1',
                                                                                             'emoji': True},
                                                                                    'value': 'check '
                                                                                             '1'}]}},
                             'radio-button': {'radio-button-action': {'type': 'radio_buttons',
                                                                      'selected_option': {'text': {'type': 'plain_text',
                                                                                          ...
                                                                                          'value': 'radio '
                                                                                                   '1'}}},
                             'multi-select': {'multi-select-action': {'type': 'multi_static_select',
                                                                      'selected_options': [{'text': {'type': 'plain_text',
                                                                                                     'text': 'multi '
                                                                                                             '1',
                                                                                                     'emoji': True},
